package com.yapmrq.platzigram.adapter;
...
import com.yapmrq.platzigram.view.PictureDetailActivity;

import java.util.ArrayList;

/**
 * Created by yapmrq on 28/11/2016.
 */
                    ...
                    activity.startActivity(intent,
                            ActivityOptionsCompat
                                    .makeSceneTransitionAnimation(
                                        activity,
                                        v,
                                        activity.getString(R.string.transitionname_imagecard))
                                    .toBundle());
                } else {
                    activity.startActivity(intent);
                }
